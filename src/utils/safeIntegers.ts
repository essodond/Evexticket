...
/**
 * Reject integer values that have already lost precision in JavaScript.
 * CockroachDB IDs must cross the JSON boundary as strings once they exceed
...
export const assertJsonBodyHasNoUnsafeIntegers = (body: BodyInit | null | undefined): void => {
